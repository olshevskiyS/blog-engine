...
import ru.olshevskiy.blogengine.model.dto.Error;
...
public class GlobalException {
  ...
  public ResponseEntity<Map<String, Boolean>> handleIncorrectCredentialsException() {
    return new ResponseEntity<>(Collections.singletonMap("result", false), HttpStatus.OK);
  }
