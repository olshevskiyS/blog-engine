...
('1', 'ACCEPTED', '1', '<textarea>Травление - это удаление оксидов на изделии (ржавчина, окалина и т.д.). Для травления используют кислоты (соляную, серную) или концентрированную щелочь. Процесс необходим для получения качественного сцепления покрытия с изделием.</textarea>', '2021-12-20 21:10:10.00000', 'Травление', '4', '2'),
('1', 'ACCEPTED', '1', '<textarea>Процесс обезжиривания. На любом изделии присутствует жировая пленка, мешающая качественному нанесению покрытия. Пленка удаляется моющим средством.</textarea>', '2021-12-20 21:41:11.00000', 'Обезжиривание', '3', '1'),
('1', 'ACCEPTED', '1', '<textarea>Соответствие техническим требованиям заказчика проверяет специалист Отдела Технического Контроля (ОТК). Измеряет толщину, адгезию (прочность сцепления), блеск, паяемость и кучу других параметров.</textarea>', '2021-12-24 09:11:57.00000', 'Контроль', '3', '2'),
('1', 'ACCEPTED', '1', '<textarea>Гальванику металла на поверхности используют для придания им свойств конкретного материала (серебро, золото, никель и т.д.). Либо если из этого материала невозможно изготовить предмет, а также если цена будет неоправданно высока.</textarea>', '2021-12-25 14:22:37.00000', 'Назначение гальванического метода', '4', '2'),
('1', 'ACCEPTED', '1', '<textarea>В ходе осаждения металлов важна температура электролита. Иногда используется дополнительное нагревательное устройство, которое погружается в гальваническую ванну или находится вне ее.</textarea>', '2021-12-26 08:50:21.00000', 'Температура электролита', '4', '3'),
('1', 'ACCEPTED', '1', '<textarea>Промывку осуществляют проточной горячей, а затем холодной водой, а после дополнительно промывают в дистиллированной воде. Последняя нужна чтобы не позволить проточной воде (и содержимся в ней вредным примесям) попасть в электролиты.</textarea>', '2021-12-27 10:36:48.00000', 'Промывка', '3', '2'),
('1', 'ACCEPTED', '1', '<textarea>В гальванике широко распространен метод гальванопластики. При этом изделие, погружаемое в гальваническую ванну, выступает в роли негатива, то есть покрытие растет не на рабочей стороне изделия а на задней, обратной стороне. На форму из непроводящего материалы осаждается слой металла, чаще всего это медь.</textarea>', '2022-01-10 13:08:18.00000', 'Гальванопластика', '5', '3'),
('0', 'NEW', '1', '<textarea>Покрытия-смазки - при их нанесении не столько учитываются химические характеристки самого металла, сколько необходимо обеспечить, например, плотную притирку деталей, но по какой-то причине нельзя использовать смазочные материалы. Это оловянные, свинцовые, индиевые покрытия.</textarea>', '2022-01-16 18:38:25.00000', 'Покрытия-смазки', '3', '0'),
('1', 'ACCEPTED', '1', '<textarea>Детали больших размеров находятся в объемных ваннах в подвешенном состоянии. На более мелкие изделия гальваническое покрытие наносится в барабанных емкостях, где отрицательный заряд подается на барабан, который вращается в электролите.</textarea>', '2022-01-17 22:08:15.00000', 'Размер изделий', '5', '1'),
('1', 'ACCEPTED', '1', '<textarea>Большое значение имеет плотность тока, который проходит через электролит. Он влияет на структуру формируемого осадка. Данная величина измеряется отношением силы тока к единице поверхности обрабатываемой детали.</textarea>', '2022-01-20 10:15:27.00000', 'Плотность тока', '5', '5'),
('1', 'ACCEPTED', '1', '<textarea>Слой родия увеличивает сопротивляемость деталей воздействию химически агрессивных сред, а также придает им дополнительную механическую стойкость. Родирование предотвращает окисление, потускнение изделий из серебра.</textarea>', '2022-01-21 15:00:27.00000', 'Родирование', '4', '3'),
('1', 'ACCEPTED', '1', '<textarea>В качестве покрытия используется медный купорос. Такая обработка способствует повышению прочности металлических изделий и повышению их токопроводящих свойств. Металлы с медным покрытием используются для производства электропроводников.</textarea>', '2022-02-05 11:50:20.00000', 'Меднение', '5', '4');
