...
('0', 'NEW', null, '<p>Металлизация пластика, которая выполняется преимущественно электрохимическим методом, позволяет значительно усилить устойчивость полимерных материалов к механическим повреждениям.</p>', '2022-02-08 20:17:24.00000', 'Металлизация пластмасс', '5', '0');
